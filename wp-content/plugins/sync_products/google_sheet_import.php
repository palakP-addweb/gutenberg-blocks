...
$spreadsheetUrl = 'https://docs.google.com/spreadsheets/d/' . $_GET['id'] . '/export?format=csv';
echo '<pre>';
print_r($spreadsheetUrl);
// Set temporary file path for the downloaded Google Sheets file
$tempFilePath = '/home/hanooot.com/public_html/api/synic-products/temp/file.csv';
