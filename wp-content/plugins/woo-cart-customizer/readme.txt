...
1. Download the zip file and extract the contents. Upload the 'woo-cart-customizer' folder to your plugins directory (e.g, wp-content/plugins/).

2. Activate the plugin through the 'Plugins' menu in WordPress.   

3. Go to WooCommerce -> Settings -> Integration Tab.

4. You can change the cart name, message and notice text and also the button text of product by its type. (e.g, Simple product, Grouped product, External product, Variable Product).
